...
```{r}
# Preprocess
BA.graph <- sample_pa(n=scn$p, power=2, m=20, directed = F)                         # increase m to increase density
...
X.params = unlist(scn$X.params, use.names = F)
da.thresh = unlist(scn$da.thresh, use.names = F)
if(is.list(dg.thresh)){dg.thresh = unlist(scn$dg.thresh)}

# -- Setup default network
dnw.params <- genDefaultNetwork(scn$p, scn$q, BA.graph, beta.params, alpha0.params, alpha12.params, X.params)
```
