...
if(is.list(dg.thresh)){dg.thresh = unlist(scn$dg.thresh)}

# -- Setup default network
dnw.params <- genDefaultNetwork(scn$p, scn$q, BA.graph, beta.params, 
                                alpha0.params, alpha12.params, X1.params, X2.params)
```
