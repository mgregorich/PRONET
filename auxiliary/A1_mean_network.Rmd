...
```{r, echo=F, warning=F, message=F}
data.graph <- genIndivNetwork(n=n, p=p, q=q, alpha=dnw.params$alpha, X.params=X.params, mu=dnw.params$mu,
                              beta.params=beta.params,eta.params = dnw.params$eta.params)
