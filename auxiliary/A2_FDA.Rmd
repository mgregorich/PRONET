...
df <-  generate_data(n = scen$n, 
                     ...
                     beta.params = unlist(scen$beta.params),
                     X1.params = unlist(scen$X1.params),
                     X2.params = unlist(scen$X2.params),
                     b0 = scen$b0,
                     b1 = scen$b1,  
                     eps.y = scen$eps.y, 
                     eps.g = scen$eps.g, 
                     dg.thresh = unlist(scen$dg.thresh))
...
list.gvars <- lapply(1:nrow(data.network), function(x) 
  data.frame("Subj"=x, wrapperThresholding(eweights=data.network[x,], msize=p)))
