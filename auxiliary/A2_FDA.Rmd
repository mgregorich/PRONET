...
In the data generation of the individual-specific networks, a weight-based approach is currently used in which all edge weights of the networks below a threshold of \tau are set to 0. The threshold $\tau$ is currently set to `r main.params$thresh`.
...
data.gvars %>%
  ...
  ggplot(aes(x=Thresh, y=Value, fill=SparsMethod)) +
  geom_boxplot() +
  stat_boxplot() +
