...
cond <- quo((b1 == 10 & b2 ==10 & epslevel.y=="none" & SparsMethod == "weight-based") & 
                     (adjust==F | AnaMethod %in% c("Oracle", "Null")))
...
tbl_loo1 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(setting, n, dg.thresh, epslevel.g, AnaMethod, RMSE.est) %>%
  pivot_wider(id_cols = c(setting, n, dg.thresh, epslevel.g), names_from = AnaMethod, values_from = RMSE.est) %>% 
...
p = nested_loop_plot(resdf = tbl_loo1,
                     ...
                     steps_y_base = min(tbl_loo1$OPT)-1, steps_y_height = 0.25,
                     steps_names = "Noise(G)",
...
cond <- quo(setting =="uni" & adjust==F & b1 == 10 & b2 ==10 & epslevel.g=="none")
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_loo2 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(SparsMethod, n,  dg.thresh, epslevel.y, AnaMethod, RMSE.est) %>%
  pivot_wider(id_cols = c(SparsMethod, n, dg.thresh, epslevel.y), names_from = AnaMethod, values_from = RMSE.est) %>% 
  mutate(n = as.factor(n)) %>%
  rename("DGM"="dg.thresh")

p = nested_loop_plot(resdf = tbl_loo2,
                     x = "n", steps = "epslevel.y",
                     grid_cols = "DGM", grid_rows = "SparsMethod",
                     steps_y_base = min(tbl_loo2$OPT)-0.2, steps_y_height = 0.05,
                     steps_names = "Noise(Y)",
                     x_name = "Sample size", y_name = "aRMSE",
                     spu_x_shift = 1.5,
                     colors = ggcols,
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=12, fig.height=6, fig.cap="", fig.fullwidth = TRUE}
cond <- quo(p==150 & setting =="uni" & adjust==F & b1 == 10 & b2 ==10 & epslevel.y=="none")
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_loo1 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(SparsMethod, n, dg.thresh, epslevel.g,AnaMethod, RMSE.est) %>%
  pivot_wider(id_cols = c(SparsMethod, n,dg.thresh, epslevel.g), names_from = AnaMethod, values_from = RMSE.est) %>% 
  mutate(n = as.factor(n)) %>%
  rename("DGM"="dg.thresh")
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=12, fig.height=6, fig.cap="", fig.fullwidth = TRUE}
cond <- quo(n==150 & p==150 & adjust==F & setting =="uni" & b1 == 10 & b2 ==10 & epslevel.y=="high")
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_gg1 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(SparsMethod, n, dg.thresh, epslevel.g,AnaMethod, RMSE.est, RMSE.lo, RMSE.up) %>%
  rename("DGM"="dg.thresh")
...
tbl_gg1 %>%
  ...
  facet_grid(SparsMethod~DGM, labeller = label_both) +
  theme_bw() +
...
cond <- quo((b1 == 10 & b2 ==10 & n==300 & SparsMethod == "weight-based") & 
                     (adjust==T | AnaMethod %in% c("Oracle", "Null", "Uni")))
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_loo6 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(setting, epslevel.y, dg.thresh, epslevel.g, AnaMethod, RMSE.est) %>%
  pivot_wider(id_cols = c(setting, epslevel.y, dg.thresh, epslevel.g), names_from = AnaMethod, values_from = RMSE.est) %>% 
  rename("DGM"="dg.thresh")

p = nested_loop_plot(resdf = tbl_loo6,
                     x = "epslevel.y", steps = "epslevel.g",
                     grid_rows="setting", grid_cols = "DGM",
                     steps_y_base = min(tbl_loo1$OPT)-1, steps_y_height = 0.25,
                     steps_names = "Noise(G)",
                     x_name = "Noise(Y)", y_name = "aRMSE",
                     spu_x_shift = 1.5,
                     colors = ggcols,
                     steps_values_annotate = TRUE, steps_annotation_size = 3,
                     hline_intercept = min(tbl_loo1$OPT),
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=12, fig.height=8, fig.cap="", fig.fullwidth = TRUE}
cond <- quo(n==150 & p==150 & adjust==F &setting =="uni" & SparsMethod == "weight-based")
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_loo6 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(b2, dg.thresh, epslevel.g, epslevel.y, AnaMethod, RMSE.est) %>%
  pivot_wider(id_cols = c(b2, dg.thresh, epslevel.g, epslevel.y), names_from = AnaMethod, values_from = RMSE.est) %>% 
  mutate_at(vars(b2), as.factor) %>%
  rename("DGM"="dg.thresh")

p = nested_loop_plot(resdf = tbl_loo6,
                     x = "epslevel.g", steps = "epslevel.y",
                     grid_rows = "b2", grid_cols = "DGM",
                     steps_y_base = -0.5, steps_y_height = 0.025,
                     x_name = "Noise(Y)", y_name = "RMSE",
                     steps_names = "Noise(G)",
                     spu_x_shift = 1.5,
                     ylim = c(0,6), y_breaks = seq(0,6,1),
                     colors = ggcols,
                     steps_values_annotate = TRUE, steps_annotation_size = 3,
                     hline_intercept = 0,
                     y_expand_add = c(1, 0.05),
                     post_processing = list(
                         add_custom_theme = list(
                           text=element_text(size=16),
                             axis.text.x = element_text(angle = -90,
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=12, fig.height=6, fig.cap="", fig.fullwidth = TRUE}
cond <- quo((n==150 & p==150  & b1 == 10 & b2==10 & SparsMethod == "weight-based" & epslevel.g == "none" ) & 
                     (adjust==F | AnaMethod %in% c("Oracle", "Null")))
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_gg2 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(dg.thresh, setting, epslevel.y, AnaMethod, RMSE.est, RMSE.lo, RMSE.up) %>%
  rename("DGM"="dg.thresh")

tbl_gg2 %>%
  ggplot(aes(x=epslevel.y, y=RMSE.est, group=AnaMethod, col=AnaMethod)) +
  geom_point() +
  geom_line() +
  scale_y_continuous("aRMSE") +
  scale_x_discrete("Noise(Y)") +
  scale_color_manual(values=ggcols) +
...
```{r}
tbl_scens %>%
  filter(n==150 & p==150 & b1 == 10 & b2==10 & SparsMethod == "weight-based" & epslevel.g == "none" & epslevel.y == "none") %>%
  dplyr::select(dg.thresh, setting, adjust, AnaMethod, RMSE.est, RMSE.lo, RMSE.up) %>%
  rename("DGM"="dg.thresh") %>%
  mutate_at(vars(RMSE.est, RMSE.lo, RMSE.up), round_0, digits=2) %>%
  mutate(RMSE=paste0(RMSE.est, " (", RMSE.lo, " ,", RMSE.up, ")")) %>%
  ...
  row_spec(c(5,10,15,20,25), extra_css ="border-bottom: 1px solid") %>%
  kable_classic(full_width = T, html_font = "Calibri")%>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = F, position = "left",fixed_thead = T)
```
...
```{r}
tbl_scens %>%
  filter(n==150 & p==150 & b1 == 10 & b2==10 & SparsMethod == "weight-based" & epslevel.g == "none" & epslevel.y == "high") %>%
  dplyr::select(dg.thresh, setting, adjust, AnaMethod, RMSE.est, RMSE.lo, RMSE.up) %>%
  rename("DGM"="dg.thresh") %>%
  mutate_at(vars(RMSE.est, RMSE.lo, RMSE.up), round_0, digits=2) %>%
  mutate(RMSE=paste0(RMSE.est, " (", RMSE.lo, " ,", RMSE.up, ")")) %>%
...
```{r}
tbl_scens %>%
  filter(n==150 & p==150 & b1 == 10 & b2==10 & SparsMethod == "weight-based" & epslevel.g == "high" & epslevel.y == "none") %>%
  dplyr::select(dg.thresh, setting, adjust, AnaMethod, RMSE.est, RMSE.lo, RMSE.up) %>%
  rename("DGM"="dg.thresh") %>%
  mutate_at(vars(RMSE.est, RMSE.lo, RMSE.up), round_0, digits=2) %>%
  mutate(RMSE=paste0(RMSE.est, " (", RMSE.lo, " ,", RMSE.up, ")")) %>%
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=12, fig.height=8, fig.cap="", fig.fullwidth = TRUE}
cond <- quo(setting =="uni" & adjust==F & b1==10 & b2 ==10 & SparsMethod == "weight-based")
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_loo1 <- tbl_scens %>%
  filter(!!cond) %>%
  dplyr::select(n,dg.thresh, epslevel.g, epslevel.y,AnaMethod, R2.est) %>%
  pivot_wider(id_cols = c(n,dg.thresh, epslevel.g, epslevel.y), names_from = AnaMethod, values_from = R2.est) %>% 
  mutate(n = as.factor(n)) %>%
  rename("DGM"="dg.thresh")

p = nested_loop_plot(resdf = tbl_loo1,
                     x = "n", steps = "epslevel.g",
                     grid_rows = "epslevel.y", grid_cols = "DGM",
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=12, fig.height=8, fig.cap="", fig.fullwidth = TRUE}
cond <- quo(setting =="uni" & adjust==F &  b2 ==10 & epslevel.g=="none" & SparsMethod == "weight-based")
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
cond <- quo(setting =="uni" & adjust==F & b1 == 10 & b2 ==10 & SparsMethod == "weight-based" & dg.thresh %in% c("single"))
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
tbl_loo5 <- tbl_tfreq  %>%
  filter(setting =="uni" & adjust==F & b1 == 10 & b2 ==10 & SparsMethod == "weight-based" & dg.thresh %in% c("single") & p==150) %>%
  mutate_at(vars(Thresh, count), as.numeric) %>%
...
p = nested_loop_plot(resdf = tbl_loo5,
                     x = "n", steps = "epslevel.g",
                     grid_cols = "Noise(Y)",
                     steps_y_base = 0.1, steps_y_height = 0.005,
                     x_name = "Sample size", 
                     y_name = "Average selected threshold",
                     steps_names = "Noise(G)",
                     spu_x_shift = 2,
...
tbl_tfreq_loo <- tbl_tfreq  %>%
  filter(setting =="uni" & adjust==F & b1 == 10 & b2 ==10 & SparsMethod == "weight-based" & dg.thresh %in% c("random") & p==150) %>%
  mutate_at(vars(Thresh, count), as.numeric) %>%
  group_by(n, dg.thresh, epslevel.g, epslevel.y) %>%
  summarise(wmean = weighted.mean(Thresh, count)) %>%
  pivot_wider(id_cols = c(n, epslevel.y, epslevel.g), names_from = dg.thresh, values_from = wmean) %>%
...
tbl_tfreq_loo <- tbl_tfreq  %>%
  filter(setting =="uni" & adjust==F & b1 == 10 & b2 ==10 & SparsMethod == "density-based") %>%
  mutate_at(vars(Thresh, count), as.numeric) %>%
  group_by(n, p, dg.thresh, epslevel.g, epslevel.y) %>%
  summarise(wmean = weighted.mean(Thresh, count)) %>%
  pivot_wider(id_cols = c(n, p, epslevel.y, epslevel.g), names_from = dg.thresh, values_from = wmean) %>%
...
tbl_funcoeff %>%
  filter(setting =="uni" & adjust==F & b1 == 10 & b2 ==10 & epslevel.y =="none" & n==150 & p ==150 & SparsMethod == "weight-based") %>%
  rename("DGM"=dg.thresh) %>%
...
tbl_funcoeff %>%
  filter(setting =="uni" & adjust==F & b1 == 10 & b2==10 & epslevel.y =="none" & n==150 & p ==150 & SparsMethod == "weight-based" & (dg.thresh %in% c("single", "random", "half-sine")) & epslevel.g %in% c("none", "high")) %>%
  rename("DGM"=dg.thresh) %>%
  rename("Noise.G"=epslevel.g) %>%
  ggplot(aes(x=fda.thresh, y=coeff.mean.ustd)) +
  geom_line() +
...
tbl_funs %>%
  filter(setting =="uni" & adjust==F & b1 == 10 & b2==10 & epslevel.g=="none" & epslevel.y =="none" & p ==150 & SparsMethod == "weight-based" & !(dg.thresh %in% c("single", "random"))) %>%
  rename("DGM"=dg.thresh) %>%
