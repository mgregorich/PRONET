...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for RMSE"}
tbl_scens %>%
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for RMSE with minimal eps.g = 0"}
tbl_scens %>%
  filter(eps.g == 0) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  ggplot(aes(x=eps.y, y=RMSE.est, group=AnaMethod, col=AnaMethod)) +
  ...
  scale_x_discrete("Random error Y") +
  scale_y_continuous("RMSE") +
  facet_nested(SparsMethod ~ ThreshMethod) +
  theme_bw() +
  theme(text = element_text(size=12))
ggsave(file = paste0(sim.path, "/fig_rmse_epsy_nested_beta_sparsmethods_dgthresh_filter_trim_epsG0.1.tiff"),
              width=1.75*200, height=1*200, units="mm", dpi=350, compression = "lzw")
...
```{r, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for RMSE with maximal eps.g = 0.05"}
tbl_scens %>%
  filter(eps.g==0.05) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
...
```{r, echo=F, warning=F, message=F, eval=eval_dgthresh, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for RMSE with minimal eps.y = 0 and varying eps.g"}
tbl_scens %>%
  filter(eps.y == 0) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  mutate(dg.thresh = paste0("DG threshold = ", dg.thresh)) %>%
...
```{r, echo=F, warning=F, message=F, eval=eval_dgthresh, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for RMSE with maximal eps.y = 1 and varying eps.g"}
tbl_scens %>%
  filter(eps.y == 1) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  mutate(dg.thresh = paste0("DG threshold = ", dg.thresh)) %>%
...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for R2"}
tbl_scens %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  mutate(dg.thresh = paste0("DG threshold = ", dg.thresh)) %>%
  ...
  theme_bw() +
  theme(text = element_text(size=12))
ggsave(file = paste0(sim.path, "/fig_R2_epsy_nested_beta_sparsmethods_dgthresh_filter_trim_epsG0.1.tiff"),
              width=1.75*200, height=1*200, units="mm", dpi=350, compression = "lzw")
```

<br>

```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for R2 with minimal eps.g = 0"}
tbl_scens %>%
  filter(eps.g == 0) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  ggplot(aes(x=eps.y, y=R2.est, group=AnaMethod, col=AnaMethod)) +
...
```{r, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for R2 with maximal eps.g = 0.05"}
tbl_scens %>%
  filter(eps.g==0.05) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  mutate(eps.g = paste0("eps G = ", eps.g)) %>%
  ...
  theme_bw() +
  theme(text = element_text(size=12))
ggsave(file = paste0(sim.path, "/fig_R2_epsy_nested_epsg_sparsmethods_dgthresh_filter_beta42_dgthresh0.4_bin.tiff"),
              width=1.75*200, height=1*200, units="mm", dpi=350, compression = "lzw")
```

<br>

```{r, echo=F, warning=F, message=F, eval=eval_dgthresh, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for R2 with minimal eps.y = 0 and varying eps.g"}
tbl_scens %>%
  filter(eps.y == 0) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  mutate(dg.thresh = paste0("DG threshold = ", dg.thresh)) %>%
  ggplot(aes(x=eps.g, y=R2.est, group=AnaMethod, col=AnaMethod)) +
  geom_ribbon(aes(x=eps.g, ymax=R2.up, ymin=R2.lo, fill=AnaMethod), linetype=2,alpha=.05) +
  geom_line() +
  geom_point() +
  scale_x_discrete("Epsilon G") +
  scale_y_continuous("R2") +
  ...
  theme_bw() +
  theme(text = element_text(size=12))
ggsave(file = paste0(sim.path, "/fig_R2_epsg_nested_beta_sparsmethods_dgthresh_filter_trim_epsY1.tiff"),
              width=1.75*200, height=1*200, units="mm", dpi=350, compression = "lzw")
```
...
```{r, echo=F, warning=F, message=F, eval=eval_dgthresh, fig.align='center', fig.width=10, fig.height=8, fig.cap="Nested line plot for R2 with maximal eps.y = 1 and varying eps.g"}
tbl_scens %>%
  filter(eps.y == 1) %>%
  mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>%
  mutate(dg.thresh = paste0("DG threshold = ", dg.thresh)) %>%
...
<!-- ### Random error G -->
<!-- ```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=10, fig.height=6, fig.cap="Nested line plot for RMSE for ThreshMethod = trim and fixed eps.y"} -->
<!-- tbl_scens %>% -->
<!--   filter(ThreshMethod %in% "trim" & eps.y == nth(eps.y,3)) %>% -->
<!--   mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>% -->
...
<!-- ```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=10, fig.height=6, fig.cap="Nested line plot for RMSE for ThreshMethod = trim and fixed small eps.y=0"} -->
<!-- tbl_scens %>% -->
<!--   filter(ThreshMethod %in% "trim" & eps.y == nth(eps.y,1)) %>% -->
<!--   mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>% -->
<!--   mutate(beta.params = paste0("beta pars = ", beta.params)) %>% -->
<!--   ggplot(aes(x=eps.g, y=RMSE.est, group=AnaMethod, col=AnaMethod)) + -->
<!--   geom_ribbon(aes(x=eps.g, ymax=RMSE.up, ymin=RMSE.lo, fill=AnaMethod), linetype=2,alpha=.05) + -->
...
<!-- ```{r, echo=F, warning=F, message=F,  fig.align='center', fig.width=10, fig.height=6, fig.cap="Nested line plot for RMSE for all ThreshMethods and fixed large eps.y"} -->
<!-- tbl_scens %>% -->
<!--   filter(eps.y == nth(eps.y,4)) %>% -->
<!--   mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>% -->
<!--   mutate(beta.params = paste0("beta pars = ", beta.params)) %>% -->
<!--   ggplot(aes(x=eps.g, y=RMSE.est, group=AnaMethod, col=AnaMethod)) + -->
<!-- #  geom_ribbon(aes(x=eps.g, ymax=RMSE.up, ymin=RMSE.lo, fill=AnaMethod), linetype=2,alpha=.05) + -->
...
<!-- ```{r, echo=F, warning=F, message=F,  fig.align='center', fig.width=10, fig.height=6, fig.cap="Nested line plot for RMSE for ThreshMethod = trim and eps.g=0"} -->
<!-- tbl_scens %>% -->
<!--   filter(ThreshMethod %in% "trim" & eps.g == 0) %>% -->
<!--   mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>% -->
<!--   mutate(beta.params = paste0("beta pars = ", beta.params)) %>% -->
<!--   ggplot(aes(x=eps.y, y=RMSE.est, group=AnaMethod, col=AnaMethod)) + -->
<!--   geom_ribbon(aes(x=eps.y, ymax=RMSE.up, ymin=RMSE.lo, fill=AnaMethod), linetype=2,alpha=.05) + -->
...
<!-- ```{r, echo=F, warning=F, message=F,  fig.align='center', fig.width=10, fig.height=6, fig.cap="Nested line plot for RMSE for beta.params c(2,4)"} -->
<!-- tbl_scens %>% -->
<!--   mutate_at(vars(beta.params, SparsMethod, AnaMethod), as.factor) %>% -->
<!--   mutate(eps.g = paste0("eps G = ", eps.g)) %>% -->
<!--   ggplot(aes(x=eps.y, y=RMSE.est, group=AnaMethod, col=AnaMethod)) + -->
