...
tmp <- str_split_fixed(tmp[40:68,], pattern = "#", n=2)
...
image(mat1, main="random", col = c("white", "black"), axes=F)
...
cond <- quo((SparsMethod == "weight-based" & network.model=="random" & epslevel.g=="none" & adjust==T & b1==10))
...
```{r, fig.align='center', fig.width=14, fig.height=10, fig.cap="", fig.fullwidth = TRUE}
cond <- quo((SparsMethod == "weight-based" & network.model=="random" & epslevel.g=="none" & adjust==F & b1==10))
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
...
```{r, fig.align='center', fig.width=14, fig.height=10, fig.cap="", fig.fullwidth = TRUE}
cond <- quo((SparsMethod == "weight-based" & network.model=="random" & epslevel.y=="none" & adjust==T & b1==10))
cond_sub <- str_remove_all(as.character(cond)[2], "[[:punct:]]")
cond_sub <- str_replace_all(cond_sub, "  ", ", ")
cond_sub <- str_replace_all(cond_sub, "==", "=")
