...
```{r, echo=F, warning=F, message=F, fig.align='center', fig.width=8, fig.height=12, fig.cap="Individual-specific variability of edge weights due to the latent processes"}
data.graph$GE %>%
  data.frame() %>%
